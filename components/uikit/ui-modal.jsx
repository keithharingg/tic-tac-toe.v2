...
export function UiModal({ width = 'md', children, className, isOpen = false, onClose }) {
  const handleClick = (e) => {
  ...
  const modal = (
    <div
      ...
      <div
        ...
        <button
          onClick={onClose}
          className="w-8 h-8 flex items-center rounded hover:bg-white/40 
        justify-center bg-white/10 transition-colors absolute top-0 left-[calc(100%+12px)]">
